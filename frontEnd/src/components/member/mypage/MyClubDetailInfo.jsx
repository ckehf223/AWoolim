...
import "/src/css/member/mypage/MyClubDetailInfo.css";
import UserProfileModal from "/src/components/member/modal/UserProfileModal";
    ...
    <>
      <section className="section-container2">
        <div className="button-group">
          <button className={"active"} onClick={() => { nav(`/includeclub/detailInfo/${param.no}`) }} >상세 정보</button>
          <button onClick={() => { nav(`/includeclub/calendar/${param.no}`) }} >캘린더 </button>
          <button onClick={() => { nav(`/includeclub/photoGallery/${param.no}`) }} > 사진첩 </button>
        </div>
                      ...
                      >
                        ...
                        <div className="myClubDetailMemberInfo">
                          <p className="myClubDetailMemberNickname">
                            {member.nickName !== null ? member.nickName : member.userName}{" "}
                            <span>
                              {clubData.club.userId === member.userId ? "(모임장)" : ""}
                            </span>
                          </p>
