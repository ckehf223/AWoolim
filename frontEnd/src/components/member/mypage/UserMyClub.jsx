...
import "/src/css/member/mypage/UserMyClub.css";
import useModal from "/src/common/useModal";
import UserExitClubModal from "/src/components/member/modal/UserExitClubModal";
...
const UserMyClub = () => {
  ...
  useEffect(() => {
    const getMyClub = async () => {
      try {
        const response = await instance.get("/api/club/readMyClub", {
