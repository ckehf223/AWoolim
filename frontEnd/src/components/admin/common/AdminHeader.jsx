...
import "/src/css/admin/common/AdminHeader.css";
  ...
  return (
    <div className="AdminHeader">
      <Navbar light expand="md" className="navbar-custom my-navbar-color">
        <NavbarBrand href="/admin/dashboard" className="navbar-brand-custom"><img src="/assets/images/headerLogo.png" /></NavbarBrand>
